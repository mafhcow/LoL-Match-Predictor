...
def parse(blue_champions, red_champions, result):
	...
	return blue_champions[0] + ' ' + red_champions[0] + ' ' + red_champions[1] + ' ' + blue_champions[1] + ' ' + blue_champions[2] + ' ' + red_champions[2] + ' ' + red_champions[3] + ' ' + blue_champions[3] + ' ' + blue_champions[4] + ' ' + red_champions[4] + '\t' + str(result)
...
out_file = open('../Data/drafted_champions.txt', 'w')
